...
Explore the API using [Swagger UI](http://petstore.swagger.wordnik.com). Run the application and point the explorer to `http://localhost:9292/api/doc` or `http://grape-on-rack.herokuapp.com/api/swagger_doc`.
